...
/**
 * Mockup screen 01 — the signed-in home. Unchanged by the marketing redesign:
 * a buyer who is already in the product wants their requests, not a pitch.
 */
export async function AppHome({ viewer }: { viewer: Viewer }) {
